	...
	},
	{
		...
		config = function()
			...
			vim.api.nvim_create_autocmd("LspAttach", {
				group = vim.api
					.nvim_create_augroup("kickstart-lsp-attach", { clear = true }),
				callback = function(event)
					...
					if client and client_supports_method(client, vim.lsp.protocol.Methods
						.textDocument_documentHighlight, event.buf) then
					...
					if client and
						client_supports_method(client,
							vim.lsp.protocol.Methods.textDocument_inlayHint, event.buf) then
